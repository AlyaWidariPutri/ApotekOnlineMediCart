    ...
    ">
        ...
        <form action="{{ route('user.login.submit') }}" method="POST">
            ...
            <div style="margin-bottom: 20px; position: relative;">
                <input type="password" name="katakunci" id="password" required style="
                    width: 100%;
                    padding: 12px 15px;
                    border: 2px solid #eee;
                    border-radius: 10px;
        ...
        <div style="text-align: center; margin-top: 30px; color: #555;">
            Don't have an account? <a href="{{ route('user.register') }}" style="color: #F28132; font-weight: 600; text-decoration: none;">Register now</a>
        </div>
    </div>
</div>
